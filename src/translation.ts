export const translations = {
  en: {
    ...
    load_game_success: "Game loaded from slot {slot}",
    load_game_failure: "No save found in slot {slot}",
  ...
  zh: {
    ...
    load_game_success: "游戏已从槽位 {slot} 加载",
    load_game_failure: "槽位 {slot} 中没有找到存档",
  ...
  ar: {
    ...
    load_game_success: "تم تحميل اللعبة من الفتحة {slot}",
    load_game_failure: "لم يتم العثور على حفظ في الفتحة {slot}",
